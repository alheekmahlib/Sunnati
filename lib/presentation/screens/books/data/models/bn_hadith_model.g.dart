...
part of 'bn_hadith_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class BNHadithModelAdapter extends TypeAdapter<BNHadithModel> {
  @override
  final int typeId = 6;

  @override
  BNHadithModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return BNHadithModel(
      banglaURN: fields[12] as int,
  ...
  @override
  void write(BinaryWriter writer, BNHadithModel obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
